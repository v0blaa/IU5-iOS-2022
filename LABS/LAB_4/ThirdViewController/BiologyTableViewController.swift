...
final class BiologyViewController: UIViewController{
    ...
    private func registerCell() {
        tableViewController.register(BiologyCellViewController.self, forCellReuseIdentifier: "BiologyTableCell")
    }
...
extension BiologyViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableViewController.dequeueReusableCell(withIdentifier: "BiologyTableCell", for: indexPath) as? BiologyCellViewController else {
            fatalError()
        }
